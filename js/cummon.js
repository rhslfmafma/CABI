...
// 지희
function sec2_slide(){
  let sec2_slideContainer = $('.sec2_slider_container'),
        sec2_sliderWrap = sec2_slideContainer.find('.sec2_slide_wrapper'),
        sec2_slides = sec2_sliderWrap.find('.sec2_slides'),
        sec2_slideLine = sec2_sliderWrap.find('.sec2_slideLine line'),
        ...
        sec2_prevBtn = $('.sec2 #sec2_prev'),
        sec2_nextBtn = $('.sec2 #sec2_next');
    ...
    let sec2_allSlide = sec2_sliderWrap.find('.sec2_slides');        
    sec2_allSlide.each(function(item, idx){
      $(item).css('left',(sec2_slideWidth * sec2_slideToShow + sec2_slideMargin * (sec2_slideToShow - 1)) * idx + 'px');    
    });
    function sec2_setSlide() {
      let sec2_MoveAmt = -(sec2_slideWidth * sec2_slideToShow + sec2_slideMargin * (sec2_slideToShow - 1)) + 'px';
      sec2_sliderWrap.css({
        'transform': `translateX(${sec2_MoveAmt})`,
        'transition': 'transform 0.5s'  // 이 부분은 선택적입니다. CSS에서 처리하는 것이 좋습니다.
      });
      sec2_sliderWrap.addClass('animated');
    }
    sec2_setSlide();
...
sec2_nextBtn.click(function() {
  slideCheck(() => {
    sec2_moveSlide(sec2_currentIdx + 1);
  }, 500);
});    
sec2_prevBtn.click(function() {
  slideCheck(() => {
    sec2_moveSlide(sec2_currentIdx - 1);
  }, 500);
});
...
$('.sec2_slideContainer').mouseenter(function(e) {
  clearInterval(Sec2_autoSet);
  Sec2_autoSet = undefined;
});    
$('.sec2_slideContainer').mouseleave(function(e) {
